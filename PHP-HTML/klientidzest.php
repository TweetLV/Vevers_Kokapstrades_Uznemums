...
<section class="adminSakums">
        <div class="row">
            ...
            <?php
                    ...
                    if(isset($_POST['dzestklienti'])){

                        $klienti_id = $_POST['dzestklienti'];

                        $dzest_klienti_SQL = "DELETE FROM klienti WHERE klienti.Klients_id = '$klienti_id'";
                        if(mysqli_query($savienojums, $dzest_klienti_SQL)){
