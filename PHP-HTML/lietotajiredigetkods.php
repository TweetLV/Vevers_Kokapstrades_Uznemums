...
<?php
                    ...
                    if(isset($_POST['lietotajirediget'])){
                        ...
                        $klients_ievade = ($klients_ievade == 'true') ? 1 : 0;
                            ...
                            if(!empty($lietotajvards_ievade) && !empty($parole_ievade) && !empty($parole_ievade) && !empty($emails_ievade)){
                            //tiek rediģēta tabula
                            ...
                            echo "<div class='pazinojums zals'>Izmaiņas ir izdevušās veiksmīgi!</div>";
                            header("Refresh:2; url=lietotaji.php");
                        }else{
                            //Nav izdevusies datu rediģēšana
                            echo "<div class='pazinojums sarkans'>Izmaiņas nav izdevušās! Kļūda sistēmā!</div>";
                            header("Refresh:2; url=lietotaji.php");
                        }
                    }else{
                        // Ievades lauku dēļ nav izdevies izmainīt datus
                        echo "<div class='pazinojums sarkans'>Izmaiņas nav izdevušās! Ievades lauku problēmas!</div>";
                        header("Refresh:2; url=lietotaji.php");
                    }
                }else{
