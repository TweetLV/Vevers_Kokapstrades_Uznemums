...
<section class="adminSakums">
        <div class="row">
            ...
            <?php
                    ...
                    if(isset($_POST['dzestmaksajumi'])){

                        $maksajumi_id = $_POST['dzestmaksajumi'];

                        $dzest_maksajumi_SQL = "DELETE FROM maksajumi WHERE maksajumi.Maksajumi_id = '$maksajumi_id'";
                        if(mysqli_query($savienojums, $dzest_maksajumi_SQL)){
