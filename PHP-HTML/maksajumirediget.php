...
<section class="adminSakums">
        <div class="row">
            <div class="info">
                <div class="head-info2">Rediģēt maksājumu</div>
                            <div class="row">
                                <form method='post' action='lietotajiredigetkods.php'>
                                    ...
                                    <input type="text" placeholder="Sutijuma_datums *" name="lietotajvards" class="box1"  required>
                                    <input type="date" placeholder="Gala_cena *" name="datums" class="box1" required>
                                    <input type="text" placeholder="Statuss *" name="statuss" class="box1" required>
